...
SoftwareSerial BT1(11, 12); // Pin 11 is the TX from the arduino perspective, connect to RX of BT controller
                            // Pin 12 is the RX from the arduino perspective, connect to TX of BT controller 
